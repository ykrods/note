...
Web開発にて、レビューの対象はコードだけでなくその前の工程も含むべきではないか
...
* まず、そもそもレビュー対象となる諸々の資料を文章に書いて残す
...
以下は内容が具体的なノウハウによりすぎている気がするがついでに紹介するもの。この辺は別の記事としてまとめ直すかもしれない。

* レビュー内容について、レビューの観点が事前に共有されているべき

  * NG/OK が事前に共有されていないからNGが出るので、最初から共有されていれば問題は起きない
  * 基本設計や、アーキテクチャと呼ばれるもので、事前に前提ルールを決める。ルールはチームで洗練させていけば良い
